...
# Read the raw files
my_path <- "/Users/utassydv/Documents/workspaces/CEU/my_repos/covid-19_analysis/"

# covid data
cv <- read_csv(paste0(my_path,'data/raw/covid_11-05-2020_raw.csv'))
# population data
...
# Save clean data
# COVID data
write_csv( df , paste0(my_path,'data/clean/covid_pop_11-05-2020_clean.csv'))
